...
ncl_value ncl_make_bool(struct ncl_interp*, bool);

intptr_t ncl_get_int_value(ncl_value);
ncl_value ncl_make_int(struct ncl_interp*, intptr_t);

char const* ncl_get_symbol_name(ncl_value);
ncl_value ncl_make_symbol(struct ncl_interp*, char const*);

char const* ncl_get_string_value(ncl_value);
ncl_value ncl_make_string(struct ncl_interp*, char const*);
